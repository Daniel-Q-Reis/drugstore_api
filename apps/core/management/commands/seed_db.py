...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--categories', type=int, default=15, help='Number of categories to create')
        parser.add_argument('--products', type=int, default=50, help='Number of products to create')
        parser.add_argument('--stock-items', type=int, default=100, help='Number of stock items to create')
        parser.add_argument('--sales', type=int, default=30, help='Number of sales to create')
