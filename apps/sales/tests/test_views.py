...
class TestSaleViewSet:
    ...
    def test_create_sale_success(self, authenticated_client, product_data):
    ...
    def test_create_sale_insufficient_stock(self, authenticated_client, product_data):
    ...
    def test_create_sale_invalid_data(self, authenticated_client):
    ...
    def test_create_sale_unauthenticated(self, api_client, product_data):
